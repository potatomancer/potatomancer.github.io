...
/* harmony import */ var _site_data_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./site-data.service */ "./src/app/site-data.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(siteData) {
        var _this = this;
        this.siteData = siteData;
        this.title = 'firebaseObserv';
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            $key: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null),
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            food: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required)
        });
        this.formControls = this.form.controls;
        this.siteData.getList().subscribe(function (list) {
            _this.items = list;
        });
    }
    ...
    AppComponent.prototype.onEraseAll = function () {
        this.siteData.eraseList();
    };
    AppComponent.prototype.onEditLast = function () {
        var item = this.items.getValue().pop();
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_site_data_service__WEBPACK_IMPORTED_MODULE_0__["SiteDataService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/***/ "./src/app/site-data.service.ts":
/*!**************************************!*\
  !*** ./src/app/site-data.service.ts ***!
  \**************************************/
/*! exports provided: SiteDataService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SiteDataService", function() { return SiteDataService; });
...
module.exports = __webpack_require__(/*! C:\Users\Joshu\Desktop\Code\Angular\firebaseObserv\src\main.ts */"./src/main.ts");
